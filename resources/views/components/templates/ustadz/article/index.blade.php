...
@section('mainContent')
    ...
    <div class="w-full pt-7 pb-12 bg-[#EEEBDD] px-7 md:px-10 flex flex-col items-center">
        ...
        <button type="button"
            class="w-15 text-white bg-[#810000] hover:bg-[#810000] focus:outline-none focus:ring-4 focus:ring-red-300 font-bold rounded-md text-sm px-2 py-1.5 mt-4 text-center dark:bg-[#810000] dark:hover:bg-[#810000] dark:focus:ring-red-900"><ion-icon name="add" class="text-base font-bold md:text-xl"></ion-icon></button>
        <div class="flex justify-center items-center">
