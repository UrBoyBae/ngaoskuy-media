...
@section('mainContent')
    ...
    <div class="w-full h-fit pt-4 pb-6 px-7">
        ...
        <x-atoms.breadcrumb-two-index firstIndexName="Home" firstIndexRoute="{{ $role }}.home.index" secondIndexName="Artikel" />
    </div>
    <div class="w-full pb-12 bg-[#EEEBDD] px-7 md:px-10 flex flex-col items-center">
        ...
        <a href="{{ route($role . '.article.create') }}">
            <div class="flex items-center w-15 text-white bg-[#810000] font-bold rounded-md text-sm px-2 py-1.5 mt-4"><ion-icon
                name="add" class="text-base font-bold md:text-xl"></ion-icon><span class="ml-1">Tambah Artikel</span></div>
        </a>
        <div class="flex justify-center items-center">
