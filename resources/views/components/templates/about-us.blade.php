...
@section('mainContent')
    <div class="w-full h-screen bg-[#EEEBDD] content-center px-9">
        ...
        <div class="w-full flex justify-center">
            <button
                class="mt-4 h-9 w-40 mr-4 rounded-full text-base font-medium text-white bg-[#942626]"data-tab="ngaos-kuy">Ngaos
                Kuy</button>
            <button
                class="mt-4 h-9 w-40 rounded-full text-base font-medium text-white bg-[#942626]"data-tab="eunola">Eunola</button>
        </div>
        {{-- ngaos kuy --}}
