            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route($role . '.video.index', $bab->id) }}"
                            class="ms-1 text-sm font-bold text-black hover:text-blue-600 md:ms-2 dark:text-black dark:hover:text-[#810000]">
                            {{$bab->kitab->name}}
                        </a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span
                            class="ms-1 text-sm font-bold truncate text-gray-500 md:ms-2 dark:text-gray-500">{{ $episode->judul->name }}</span>
                    </div>
                </li>
            </ol>
        </nav>
